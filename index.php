...
<body>
	<div class="wrapper">
		<!-- HEADER START -->
		<div class="header">
			<a href="."><img class="logo" src="website_logo.png"></a>
			<div class="dropdown">
				<ul>
		...
		<!-- FOOTER START -->
		<div class="footer">
			Copyright (c) 2013 Techwolf / Project 691. | Design & <a href="https://github.com/team691/website">code</a> by Techwolf.		</div>
